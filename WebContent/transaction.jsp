...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/transaction.css" rel="stylesheet">
...
<body>
	...
	<div class="membership">
		...
		<p class="left">free viewing only
			<a href="upgrade.jsp">pay for full membership</a>
		</p>
		<p class="right">Status: Not paid up</p>
	</div>
	</div>
	</div>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/actions.js"></script>
